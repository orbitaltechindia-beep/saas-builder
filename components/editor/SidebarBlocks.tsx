...
function DraggableBlock({ id, type, label, icon }: { id: string; type: string; label: string; icon: React.ReactNode }) {
  ...
  return (
    <div
      ...
      {...listeners}
      {...attributes}
      className="flex items-center gap-3 bg-neutral-800 p-3 rounded-md cursor-grab active:cursor-grabbing hover:bg-neutral-700 transition-colors text-neutral-200 text-sm border border-neutral-700/50 shadow-sm"
    >
